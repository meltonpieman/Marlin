...
#define SENSORLESS_BACKOFF_MM  { 2, 2 }     // (mm) Backoff from endstops before sensorless homing // 2.0.6

#define HOMING_BUMP_MM      { 5, 5, 2 }       // (mm) Backoff from endstops after first bump // 2.0.6
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate) // 2.0.6
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MILLIMETER_UNITS         // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps // 2.0.6
  #define BABYSTEP_MULTIPLICATOR_Z  0.05       // (steps or mm) Steps or millimeter distance for each Z babystep //  max is 0.1mm 2.0.6
  #define BABYSTEP_MULTIPLICATOR_XY 0.05       // (steps or mm) Steps or millimeter distance for each XY babystep // max is 0.1mm 2.0.6
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g. 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 // 2.0.6
#else
 ...
 */
#define EMERGENCY_PARSER // WAS A CONFLICT WITH TFT 35 E3 v3 but needed for larger buffer sizes // 20/06/26 2.0.6
