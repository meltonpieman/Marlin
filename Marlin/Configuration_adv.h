 ...
 *
 * Based on Sprinter and grbl. ALTS // 20/05/27 20/06/03 20/06/05 20/06/11 20/06/12
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    #define X_CURRENT_HOME  (X_CURRENT)  // (mA) RMS current for sensorless homing // 20/06/05 was X_CURRENT // 20/06/11
    ...
    #define Y_CURRENT_HOME  (Y_CURRENT)  // 20/06/05 was Y_CURRENT // 20/06/11
    #define Y_MICROSTEPS     16
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only // 20/05/27
    ...
    #define X_STALL_SENSITIVITY  40 // 20/06/12
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  70 // 20/06/12
